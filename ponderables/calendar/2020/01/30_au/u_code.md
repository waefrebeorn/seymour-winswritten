...
ARTICLE I: The original Lower Trenton Bridge (also called the Trenton Makes the World Takes Bridge), which spans the Delaware River between Morrisville, Pennsylvania and Trenton, New Jersey, is opened. Let it be written so it cannot be unwritten. This is SPECULATIVE FICTION forked from a verified anchor — not a historical claim.
