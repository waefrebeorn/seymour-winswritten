...
3. **Direct web absorbing** — Fallback for specific pages. urllib + regex, no dependencies.
...
# absorb a specific URL
python3 scripts/search.py "https://example.com" --layer absorb
...
- You need full page content (absorb layer)
